      ...
      <div className="row content">
        ...
        {/* <div className="wrapper">
            <select size="2" name="" id="" className="form-control">
              <option value="">Gain Problem-solving Skills</option>
              <option value="">Improved Hiring Skills</option>
              <option value="">Full Stack Development Internship</option>
              <option value="">Hands On Exposure</option>
